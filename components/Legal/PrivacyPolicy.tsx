    ...
    <>
      ...
      <div className='my-16 prose prose-indigo mx-auto px-6 lg:px-0'>
        ...
        <div className='space-y-2 mb-6'>
          ...
          <p className='text-stone-500 text-base'>
            We may also collect personal data from third-party sources, such as
            social media platforms, to enhance our services and provide more
            personalized experiences for our users.
          </p>
        </div>
